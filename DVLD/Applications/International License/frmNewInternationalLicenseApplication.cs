...
namespace DVLD.Applications.International_License
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void frmNewInternationalLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblFees.Text = clsApplicationTypes.FindApplicationTypes((int)clsApplications.enApplicationType.NewInternationalLicense).ApplicationFees.ToString();
        ...
        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
            ...
            InternationalLicense.PaidFees = clsApplicationTypes.FindApplicationTypes((int)clsApplications.enApplicationType.NewInternationalLicense).ApplicationFees;
