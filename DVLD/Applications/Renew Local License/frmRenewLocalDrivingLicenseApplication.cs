...
namespace DVLD.Applications.Renew_Local_License
{
    public partial class frmRenewLocalDrivingLicenseApplication : Form
    {
        ...
        private void frmRenewLocalDrivingLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblApplicationFees.Text = clsApplicationTypes.FindApplicationTypes((int)clsApplications.enApplicationType.RenewDrivingLicense).ApplicationFees.ToString();
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            int DefaultValidityLength = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.LicenseClassesInfo.DefaultValidityLength;
