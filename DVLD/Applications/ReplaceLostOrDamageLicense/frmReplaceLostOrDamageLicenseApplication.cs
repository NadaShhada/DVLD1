...
using static Bussiness_Layer.clsLicenses;
...
namespace DVLD.Applications.ReplaceLostOrDamageLicense
{
    public partial class frmReplaceLostOrDamageLicenseApplication : Form
    {
        ...
        private void rbDamagedLicense_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblApplicationFees.Text = clsApplicationTypes.FindApplicationTypes(_GetApplicationTypeID()).ApplicationFees.ToString();
