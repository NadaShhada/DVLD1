...
{
    public partial class frmListDetainLicenseApplication : Form
    {
        ...
        private void frmListDetainLicenseApplication_Load(object sender, EventArgs e)
        {
        ...
        private void showPersonLicenseHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int PersonID = clsLicenses.FindLicenses(LicenseID).DriverInfo.PersonID;
        ...
        {
            frmDetainLicenseApplcation frm = new frmDetainLicenseApplcation();
            frm.ShowDialog();
            //refresh
            frmListDetainLicenseApplication_Load(null, null);
