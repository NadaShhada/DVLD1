...
namespace DVLD.Licenses.Local_Licenses
{
    public partial class frmIssueDriverLicenseFirstTime : Form
    {
        ...
        public frmIssueDriverLicenseFirstTime( int LocalDrivingLicenseApplicationID = -1)
        ...
        { txtNotes.Focus();
            _LocalDrivingLicenseApplication=clsLocalDrivingLicenseApplications.FindLocalDrivingLicenseApplications(_LocalDrivingLicenseApplicationID);
