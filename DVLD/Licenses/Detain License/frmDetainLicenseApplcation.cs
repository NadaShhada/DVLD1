...
{
    public partial class frmDetainLicenseApplcation : Form
    {
        private int _DetainID = -1;
        private int _SelectedLicenseID = -1;
        public frmDetainLicenseApplcation()
        {
            InitializeComponent();
        }
        ...
        private void frmDetainLicenseApplcation_Load(object sender, EventArgs e)
        {
        ...
        private void frmDetainLicenseApplcation_Activated(object sender, EventArgs e)
        {
        ...
        private void txtFineFees_Validated(object sender, CancelEventArgs e)
        {
