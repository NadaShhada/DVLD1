...
namespace Bussiness_Layer
{
    public class clsApplicationTypes
    {
        ...
        clsApplicationTypes(int ApplicationTypeID, string ApplicationTypeTitle, float ApplicationFees)
        {
        ...
        private bool _UpdateApplicationTypes()
        {
            ...
            bool IsSuccess = clsApplicationTypesData.UpdateApplicationTypes(ApplicationTypeID, ApplicationTypeTitle, ApplicationFees);


            return IsSuccess;
        }

        public static clsApplicationTypes FindApplicationTypes(int ApplicationTypeID)
        {
            string ApplicationTypeTitle = ""; float ApplicationFees = -1;

            if (clsApplicationTypesData.FindApplicationTypes(ref ApplicationTypeID, ApplicationTypeTitle, ApplicationFees))
            {
