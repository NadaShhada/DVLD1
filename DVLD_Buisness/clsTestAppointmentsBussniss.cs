...
namespace DVLD_Buisness
{
    public class clsTestAppointment
    {
...

        {
            ...
            this.RetakeTestAppInfo = clsApplications.FindBaseApplicationsType(RetakeTestApplicationID);
            Mode = enMode.Update;
        }
        ...
        public static DataTable GetAllAppointmentsByLocalDrivingLicenseApplicationID(int LocalDrivingLicenseApplicationID)
        {
            return clsTestAppointmentData.GetAllAppointmentsByLocalDrivingLicenseApplicationID(LocalDrivingLicenseApplicationID);
        }
